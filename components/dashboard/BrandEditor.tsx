  ...
  return (
    <div className="dash-grid" style={{ gridTemplateColumns: '1fr 1fr', gap: 22 }}>
      <div className="panel">
        ...
        <p>Upload a logo, choose a preset, or pick custom colors.</p>

        <div style={{ marginTop: 18 }}>
          <LogoUploader cafeId={cafe.id} currentLogoUrl={cafe.logo_url} />
        </div>
        ...
        <div className="panel" style={{ marginBottom: 14 }}>
          ...
          <div style={{ marginTop: 16 }}>
            <LoyaltyCard
              ...
              cardText={form.card_text}
              cardOpacity={form.card_opacity}
              size="lg"
            />
          </div>
        </div>

...
export type StampRequestStatus = 'pending' | 'approved' | 'rejected' | 'expired' | 'cancelled';
export type CampaignStatus = 'draft' | 'active' | 'paused' | 'archived';
export type RedemptionStatus = 'available' | 'redeemed' | 'expired' | 'cancelled';
  ...
  public: {
    Tables: {
      ...
      reward_redemptions: {
        ...
        Insert: Omit<Database['public']['Tables']['reward_redemptions']['Row'], 'id' | 'earned_at' | 'redemption_code'> & {
          id?: string;
          earned_at?: string;
          redemption_code?: string;
        };
    ...
    Functions: {
      ...
      approve_stamp: {
        ...
        Returns: { approved: boolean; reward_issued: boolean; redemption_id: string | null };
      };
      reject_stamp: {
      ...
      redeem_reward: {
        Args: { p_redemption_id: string; p_branch_id?: string | null };
        Returns: void;
      };
      get_my_active_redemptions: {
        Args: Record<string, never>;
        Returns: Database['public']['Tables']['reward_redemptions']['Row'][];
      };
      get_cafe_pending_redemptions: {

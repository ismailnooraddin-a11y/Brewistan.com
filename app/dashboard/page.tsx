...
import { getCurrentProfile, getOwnedCafe, getCafeStats, getActiveCampaign } from '@/lib/queries';
      ...
      <>
        <div className="dash-head">
          <div>
            ...
            <p className="hint">You're signed in but haven't created your café yet.</p>
          </div>
        </div>
        <div className="empty">
